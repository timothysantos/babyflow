...
describe('correction restore parity', () => {
  it('restore from Journal returns the value to Timeline and Journal projections', async () => {
    render(
      <MemoryRouter>
        <TodayPage />
      </MemoryRouter>
    ...
    await waitFor(() => expect(screen.getByTestId('correction-history-items').textContent).toContain('correction.restore'));
