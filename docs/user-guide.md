...
![Today top summary and dock](./user-guide/01-mobile-top.png)

![Row details with live logs](./user-guide/02-mobile-details.png)

![Timeline correction sheet](./user-guide/03-mobile-timeline-sheet.png)

![Journal view](./user-guide/04-mobile-journal.png)
